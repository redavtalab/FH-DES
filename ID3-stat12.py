...
def initialize_ds(pool_classifiers, uncalibratedpool, X_DSEL, y_DSEL, k=7):
    ...
    list_ds = [majority_voting, single_best, oracle,knorau, kne, ola,mcb, desknn,rank,knop,meta,desfh_w,desfh_m]
    methods_names = ['MV', 'SB', 'Oracle', 'KNORA-U', 'KNORA-E', 'OLA', 'MCB', 'DESKNN', 'RANK', 'KNOP', 'META-DES', 'FH-DES-C', 'FH-DES-M' ]
...
ExperimentPath = "ComplexClassifiers"
NO_classifiers =100
no_itr = 20
