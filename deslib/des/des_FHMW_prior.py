...
class DESFHMW_prior(BaseDES):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        super(DESFHMW_prior, self).__init__(pool_classifiers=pool_classifiers,
                                    with_IH=with_IH,
                                    safe_k=safe_k,
                                    IH_rate=IH_rate,
    ...
    def fit(self, X, y):
        ...
        super(DESFHMW_prior, self).fit(X, y)
    ...
    def FMM_train(self, classifier_ind):
        ...
        for ind, x in enumerate(X):
            ...
            for ind in sorted_indexes:
                ...
                expd = nearest_box.is_expandable(x,theta=self.theta)
                no_ovlp = not nearest_box.will_overlap_accur(conBoxes, x)
                if ( expd and no_ovlp):
