...
class FHDES_prior(BaseDES):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        super(FHDES_prior, self).__init__(pool_classifiers=pool_classifiers,
                                    with_IH=with_IH,
                                    safe_k=safe_k,
                                    IH_rate=IH_rate,
    ...
    def fit(self, X, y):
        ...
        super(FHDES_prior, self).fit(X, y)
    ...
    def setup_hyperboxs(self, classifier ):
        ...
        for ind, X in enumerate(selected_samples):
            ...
            for ind in sorted_indexes:
                ...
                if nearest_box.is_expandable(X) and not nearest_box.will_exceed_samples(X, contraction_samples):
